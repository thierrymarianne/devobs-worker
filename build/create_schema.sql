...
CREATE TABLE weaving_aggregate (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, screen_name VARCHAR(255) DEFAULT NULL, locked BOOLEAN NOT NULL, locked_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, unlocked_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, list_id VARCHAR(255) DEFAULT NULL, total_members INT DEFAULT 0 NOT NULL, total_statuses INT DEFAULT 0 NOT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
CREATE INDEX name ON weaving_aggregate (name, screen_name);
...
ALTER TABLE archived_timely_status ADD CONSTRAINT FK_80FB7224D0BBCCBE FOREIGN KEY (aggregate_id) REFERENCES weaving_aggregate (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE highlight ADD CONSTRAINT FK_C998D834D0BBCCBE FOREIGN KEY (aggregate_id) REFERENCES weaving_aggregate (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE keyword ADD CONSTRAINT FK_5A93713BD0BBCCBE FOREIGN KEY (aggregate_id) REFERENCES weaving_aggregate (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE timely_status ADD CONSTRAINT FK_7A5BB7E8D0BBCCBE FOREIGN KEY (aggregate_id) REFERENCES weaving_aggregate (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE weaving_archived_status_aggregate ADD CONSTRAINT FK_6C6940DAD0BBCCBE FOREIGN KEY (aggregate_id) REFERENCES weaving_aggregate (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE weaving_status_aggregate ADD CONSTRAINT FK_53DF6C4DD0BBCCBE FOREIGN KEY (aggregate_id) REFERENCES weaving_aggregate (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
